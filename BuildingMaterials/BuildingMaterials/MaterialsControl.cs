...
namespace BuildingMaterials
{
    public partial class MaterialsControl : UserControl
    {
        ...
        private void GetInfo()
        {
            ...
            string cmd = "select * from стройматериал";
        ...
        public MaterialsControl(bool Read, bool Write, bool Edit, bool Delete)
        {
            InitializeComponent();
        ...
        private void delete_b_Click(object sender, EventArgs e)
        {
            ...
            string cmd = "select count(*) from склад where код_материала = @id";
            ...
            if (count > 0)
            {
                MessageBox.Show("Невозможно удалить материал, так как он используется в другой записи!");
                return;
            }

            connection.Open();

            cmd = "delete from стройматериал where код_материала = @id";
