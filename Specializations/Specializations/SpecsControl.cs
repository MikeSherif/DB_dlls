...
{
    public partial class SpecsControl : UserControl
    {
        ...
        private void GetInfo()
        {
            ...
            string cmd = "select * from специализация";
        ...
        public SpecsControl(bool Read, bool Write, bool Edit, bool Delete)
        {
            InitializeComponent();
        ...
        private void delete_b_Click(object sender, EventArgs e)
        {
            ...
            string cmd = "select count(*) from специализации_строителей where код_специализации = @id";
            ...
            if (count > 0)
            {
                MessageBox.Show("Невозможно удалить специализацию, так как она используется в другой записи!");
                return;
            }

            connection.Open();

            cmd = "delete from специализация where код_специализации = @id";
